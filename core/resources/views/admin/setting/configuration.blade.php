                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                ...
                                <div>
                                    <p class="fw-bold mb-0">@lang('Freelancer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no any freelancer can register on this system.')</small>
                                    </p>
                                </div>
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Buyer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no any buyer can register on this system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Buyer)')</span>
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, buyer job posts will be automatically approved. Otherwise, the authority will manually handle the approval of posts for visibility.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
