...
class ForgotPasswordController extends Controller
{
    public function showLinkRequestForm()
    {
        ...
        return view('Template::buyer.auth.passwords.email', compact('pageTitle'));
    }
    ...
    public function codeVerify(Request $request){
        ...
        return view('Template::buyer.auth.passwords.code_verify',compact('pageTitle','email'));
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        return to_route('buyer.password.reset', $code)->withNotify($notify);
    }
